We provided the raw data (responses from LLMs) for all experiments, as well as trial data (the full prompt we gave to LLMs) for exp2, exp5, and exp6 (since other experiments rely on copyrighted treebank data). We also provided a script to generate the preprocessed data from the raw data, and compare the data with previously released data in our [Github repo](https://github.com/y1ny/WordDeletion) (also see our complete processing and analysis scripts in that repo).
